...
import { KnowKamala3 } from '../../shared/KnowKamala3';
...
const Level3 = (props) => {
    ...
    const randomOptions = () => {
        ...
        for (let i = 0; i < 2; i++) {
            if (i == 0) {
                names.push(slice[0].answer1);
            }
            else if (i == 1) {
                names.push(slice[0].answer2);
            }
        }

        let exists = false;
        for (let i = 0; i < names.length; i++) {
            if (names[i] === question[currentQuestion].answer2) {
                exists = true;
            }
        }
    ...
    const checkAnswer = (input) => {
        let lyf;
        if (input == question[currentQuestion].answer2) {
            setScore(score + 1);
        } else {
            setLife(life - 1);
        }
